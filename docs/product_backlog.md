...
**Versión:** 1.0
**Basado en:** Documento de Alcance v2, Decisiones de Arquitectura v1, DER v1
**Fuente de verdad:** este archivo. Si se modifica, replicar los cambios en `Backlog_Barberia_v1.xlsx` (hoja "Product Backlog").

## Cómo leer este backlog

Cada funcionalidad del Documento de Alcance se convirtió en una Historia de Usuario (HU) con criterios de aceptación verificables. La prioridad sigue el esquema MoSCoW:
...
Las HU que dependen de una decisión registrada en el Documento de Decisiones de Arquitectura incluyen una referencia al ADR correspondiente.

Campos por HU: `id`, `módulo`, `título`, `prioridad`, `sprint sugerido`, `adr relacionado`, narrativa (Como/Quiero/Para), criterios de aceptación.
...
- **Prioridad:** Should · **Sprint sugerido:** 2 · **ADR relacionado:** —
...
- **Prioridad:** Should · **Sprint sugerido:** 3 · **ADR relacionado:** ADR-01
...
- **Prioridad:** Must · **Sprint sugerido:** 1 · **ADR relacionado:** ADR-02
...
- **Prioridad:** Must · **Sprint sugerido:** 3 · **ADR relacionado:** —
...
- **Prioridad:** Must · **Sprint sugerido:** 1 · **ADR relacionado:** ADR-03
...
- **Prioridad:** Should · **Sprint sugerido:** 3 · **ADR relacionado:** —
...
| Sprint | HU incluidas |
|---|---|
| 1 | HU-TUR-01, HU-TUR-02, HU-TUR-03, HU-TUR-04, HU-TUR-08, HU-CLI-01, HU-SER-01, HU-SEG-01, HU-SEG-02 |
| 2 | HU-TUR-05, HU-TUR-06, HU-CLI-02, HU-SER-02, HU-SER-03 |
| 3 | HU-TUR-07, HU-CLI-03, HU-SEG-03 |

El detalle del orden de desarrollo dentro del Sprint 1 está en `sprint_1_backlog.md`.
