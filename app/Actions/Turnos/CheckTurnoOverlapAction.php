...
class CheckTurnoOverlapAction
{
     ...
     */
    public function execute(string $barberiaId, Carbon $fechaHoraInicio, Carbon $fechaHoraFin, ?string $excludeTurnoId = null): bool
    {
        ...
        return $query->where(function ($query) use ($fechaHoraInicio, $fechaHoraFin) {
